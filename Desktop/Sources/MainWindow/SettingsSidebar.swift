...
struct SettingsSearchItem: Identifiable {
    ...
    static let allSearchableItems: [SettingsSearchItem] = [
        ...
        SettingsSearchItem(name: "Ask Before File Edits & Shell Commands", subtitle: "Pause for approval before the AI edits files or runs shell commands", keywords: ["approval", "approve", "permission", "ask before", "confirm", "destructive", "cage", "safety", "shell", "bash", "file edits", "delete"], section: .advanced, advancedSubsection: .aiChat, icon: "cpu", settingId: "aichat.approvalgate"),
