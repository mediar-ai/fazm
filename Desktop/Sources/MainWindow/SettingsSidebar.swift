...
struct SettingsSearchItem: Identifiable {
    ...
    static let allSearchableItems: [SettingsSearchItem] = [
        ...
        SettingsSearchItem(name: "Fazm Managed Browser", subtitle: "Import cookies and sessions into Fazm's own Chrome instance", keywords: ["managed browser", "browser harness", "import sessions", "cookies", "localstorage", "arc", "chrome profile"], section: .advanced, advancedSubsection: .aiChat, icon: "cpu", settingId: "aichat.managedbrowser"),
